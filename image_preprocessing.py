...
pokemon_dataset_dir = 'pokemon_dataset'
processed_dataset = 'HQ_dataset'
...
for each in os.listdir(pokemon_dir):
    ...
    img.load()
    rgb_img = rgba2rgb(img).resize((1024, 1024),Image.LANCZOS)
...
for each in os.listdir(white_background_dir):
    ...
    img.load()
    flip_img = flip_image(img).resize((1024, 1024),Image.LANCZOS)
